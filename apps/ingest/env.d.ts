...
type _CoercedEnvSchema_d0b0b97a = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_d0b0b97a> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_d0b0b97a, 'APP_ENV'>> {}
}
...
type _EnvSchemaAsStrings_d0b0b97a = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_d0b0b97a {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_d0b0b97a {}
  }
}