...
type _CoercedEnvSchema_8ea85a4e = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_8ea85a4e> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_8ea85a4e, ''>> {}
}
...
type _EnvSchemaAsStrings_8ea85a4e = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_8ea85a4e {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_8ea85a4e {}
  }
}