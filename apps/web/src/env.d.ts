...
type _CoercedEnvSchema_a06b2b1d = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_a06b2b1d> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_a06b2b1d, 'APP_ENV'>> {}
}
...
type _EnvSchemaAsStrings_a06b2b1d = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_a06b2b1d {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_a06b2b1d {}
  }
}