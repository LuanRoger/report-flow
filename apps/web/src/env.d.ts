...
type _CoercedEnvSchema_20a2604c = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_20a2604c> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_20a2604c, 'APP_ENV'>> {}
}
...
type _EnvSchemaAsStrings_20a2604c = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_20a2604c {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_20a2604c {}
  }
}